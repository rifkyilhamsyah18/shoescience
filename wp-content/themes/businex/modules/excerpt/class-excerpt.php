...
* @since Businex: 0.1
*/
if( ! class_exists( 'Businex_Excerpt' ) ):

class Businex_Excerpt{
    ...
    */
    ...
    /**
    * So you can call: businex_excerpt( 'short' );
    *
    * @since  Businex 1.0.0
    * @access protected
    * @var    array
...
/**
* Call to Businex_Excerpt
*
* @since  1.0.0
* @uses   Businex_Excerpt:::get_instance()->excerpt()
* @param  int $length
* @return void
*/
if( ! function_exists( 'businex_excerpt' ) ):

    function businex_excerpt( $length = 55, $echo = true, $more = '' ) {
        $length = apply_filters( 'businex_excerpt_length', $length );
        return Businex_Excerpt::get_instance()->excerpt( $length, $echo, $more );
    }
endif;