...
final class Businex_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'Businex_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new Businex_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
					'title'    => esc_html__( 'Businex Pro', 'businex' ),
					'priority' => 1,
					'pro_text' => esc_html__( 'Go Pro', 'businex' ),
					'pro_url'  => 'https://keonthemes.com/downloads/businex-pro'
				)
			)
		);
	}
...
Businex_Customize::get_instance();
